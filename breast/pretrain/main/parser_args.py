...
# Data specifications
parser.add_argument('--pretrain_data_dir', type=str, default='/root/autodl-tmp/datanew/new/', help='pretrain dataset directory')
...
parser.add_argument('--save_models_dir', type= str,default='/root/autodl-tmp/breast/pretrain/result/model_statedict/', help='save all model statedicts')
parser.add_argument('--save_train_epoch_loss', type=str, default='/root/autodl-tmp/breast/pretrain/result/loss/train_eval.xlsx', help='save the value of train and eval loss per epoch')
...
parser.add_argument('--num_topk2_neg', type=int, default=12, help='negative pairs for hard triplet loss')
...
parser.add_argument('--train_batch_size', type=int, default=128, help='input batch size for training')
...
parser.add_argument('--temperature', type=int, default=0.5, help='Temperature in InfoNCEloss')
'''训练阶段自定义画图'''
