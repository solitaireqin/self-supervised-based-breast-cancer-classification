...
parser.add_argument('--load_statedict', type=str,default='/root/autodl-tmp/breast/downstream/result/model_epoch_1.pth', help='load_statedict')
parser.add_argument('--load_statedict_type', type=str,default='t', help='load_statedict_type')

# Hardware specifications
parser.add_argument('--n_threads', type=int, default=8, help='number of threads for data loading')
parser.add_argument('--cpu', action='store_true',help='use cpu only')
parser.add_argument('--GPU_id', type=int, default=0,help='number of GPUs')
parser.add_argument('--device', type=str, default='cuda:0',help='Id of GPUs')
parser.add_argument('--seed', type=int, default=1234,help='random seed')

# Data specifications
parser.add_argument('--train_dir', type=str, default='/root/autodl-tmp/downstream_data/train/images', help='syu train dataset directory')
parser.add_argument('--test_dir', type=str, default='/root/autodl-tmp/downstream_data/test/images', help='syu test dataset directory')
parser.add_argument('--train_labels', type=str, default='/root/autodl-tmp/downstream_data/train.csv', help='syu_train.csv')
parser.add_argument('--test_labels', type=str, default='/root/autodl-tmp/downstream_data/test.csv', help='syu_test.csv')
parser.add_argument('--syu_xls', type=str, default='../data/images/syu.xls', help='syu.xls')

# Result(model or state or loss) to save
parser.add_argument('--save_model_dir', type= str,default='/root/autodl-tmp/breast/downstream/result', help='save all model statedicts')
...
parser.add_argument('--channels', type=str, default='L', help='number of color channels to use')
parser.add_argument('--split', type=int, default=80)
parser.add_argument('--indices', type=int, default=2170)
...
parser.add_argument('--beta', type=tuple, default=(0.9, 0.999), help='ADAM beta')
...
# mode
parser.add_argument('--mode', type=str, default='test', choices=['train','test'], help='Choose to train or test or inference')
